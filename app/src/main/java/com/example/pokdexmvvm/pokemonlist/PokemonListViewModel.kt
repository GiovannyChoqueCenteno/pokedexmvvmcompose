package com.example.pokdexmvvm.pokemonlist
...
import com.example.pokdexmvvm.data.models.PokemonListEntry
import com.example.pokdexmvvm.repository.PokemonRepository
import com.example.pokdexmvvm.util.Constants.PAGE_SIZE
...
class PokemonListViewModel @Inject constructor(
    ...
    fun loadPokemonPaginated() {
        viewModelScope.launch {
            ...
            val result = repository.getPokemonList(PAGE_SIZE, PAGE_SIZE * curPages)
            when (result) {
                is Resource.Success -> {
                    endReached.value = curPages * PAGE_SIZE >= result.data!!.count
    ...
    fun calcDominantColor(drawable: Drawable, onFinis: (Color) -> Unit) {
